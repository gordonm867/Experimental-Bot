...
@Autonomous(name="RIGHT Wall Park Auto",group="Scrimmage")
public class RedParkAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.openClamp();
        runToPoint(new Point(5.25, 0));

        /*
        runToPoint(new Point(1.5, 2));
        runToPoint(new Point(1.5, 2.5));
        robot.lockFoundation();
        sleep(1000);
        runToPoint(new Point(2.5, 3.75));
        robot.unlockFoundation();
        Globals.MAX_SPEED = 1;
        sleep(1000);
        runBackToPoint(new Point(4, 1));
