...
@Disabled
public class GOFAutonomousGoldCrater extends OpMode {
    ...
    public void loop() {
        ...
        if((robot.frontDistanceSensor.getDistance(DistanceUnit.INCH) > 0.75)) {
            ...
            robot.lfWheel.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            robot.lrWheel.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            robot.rrWheel.setTargetPosition((int)(1120 * (23.82 / Math.PI)));
            robot.rfWheel.setTargetPosition((int)(1120 * (23.82 / Math.PI)));
            robot.lrWheel.setTargetPosition(((int)(1120 * (23.82 / Math.PI))));
            robot.lfWheel.setTargetPosition(((int)(1120 * (23.82 / Math.PI))));
