...
@Autonomous(name="BLUE 1st Foundation Two Stone Autonomous", group="Trash")
@Config
//@Disabled
public class BlueNewTwoBlock extends MyOpMode {
    ...
    public void startOp() {
        ...
        if(skystone == 0) {
            ...
            targets.add(new RobotState(-2.7, -3.4 + (2f/3f), 135, Globals.EXTEND_POS, -1, true, Globals.boxDown, 2100, true)); // 1
            targets.add(new RobotState(-3.3, -3.4 + (2f / 3f), 90, 0, 0, false, Globals.boxNeutral, 0, false)); // 2
            ...
            targets.add(new RobotState(-3.3, -2 + (2f / 3f), 135, Globals.EXTEND_POS, 0, false, Globals.boxNeutral, 0, true)); // 9
            targets.add(new RobotState(-2.7, -1.7 + (2f / 3f), 135, Globals.EXTEND_POS, -1, true, Globals.boxDown, 2100, true)); // 10
            ...
            targets.add(new RobotState(-3, -1, 100, 0, 0, true, Globals.boxNeutral, 0, false)); // 14
            targets.add(new RobotState(-2.7, -3, 135, Globals.EXTEND_POS, -1, true, Globals.boxDown, 2100, true)); // 15
            ...
            /* First Block */
            targets.add(new RobotState(-5.25, -3.2, 180, 0, 0, true, Globals.boxNeutral, 0, true)); // 0
            targets.add(new RobotState(-2.7, -3.4, 135, Globals.EXTEND_POS, -1, true, Globals.boxDown, 2100, true)); // 1
            ...
            /* Second Block */
            //targets.add(new RobotState(-3.6, -1.25 + (2f / 3f), 90, 0, 0, true, Globals.boxNeutral, 0, false)); // 8
            targets.add(new RobotState(-3, -2.8, 135, Globals.EXTEND_POS, 0, false, Globals.boxNeutral , 0, true)); // 9
            targets.add(new RobotState(-2.7, -2.8, 135, Globals.EXTEND_POS, -1, true, Globals.boxDown, 2100, true)); // 10

            /* Place */
            targets.add(new RobotState(-3.6, -1, -90, 0, 1, true, Globals.boxNeutral, 0, false)); // 11
            targets.add(new RobotState(-3.6, 1, -90, 0, 0, true, Globals.boxNeutral, 0, false)); // 12
            targets.add(new RobotState(-3.8, 2.25, -100, Globals.EXTEND_POS, 1, false, Globals.boxNeutral, 2000, true)); // 13

            targets.add(new RobotState(-3, -1, 100, 0, 0, true, Globals.boxNeutral, 0, false)); // 14
            targets.add(new RobotState(-2.7, -3, 135, Globals.EXTEND_POS, -1, true, Globals.boxDown, 2100, true)); // 15
            targets.add(new RobotState(-2.5, -3, 135, 0, 0, true, Globals.boxNeutral, 0, true)); // 16
            targets.add(new RobotState(-3.4, 2.05, -90, Globals.EXTEND_POS, 1, true, Globals.boxNeutral, 2000, true)); // 17
            ...
            /* First Block */
            targets.add(new RobotState(-5.25, -3.2, 180, 0, 0, true, Globals.boxNeutral, 0, true)); // 0
            targets.add(new RobotState(-2.7, -3.4 + (4f/3f), 135, Globals.EXTEND_POS, -1, true, Globals.boxDown, 2100, true)); // 1
            ...
            /* Second Block */
            //targets.add(new RobotState(-3.6, -1.25 + (2f / 3f), 90, 0, 0, true, Globals.boxNeutral, 0, false)); // 8
            targets.add(new RobotState(-3, -1, 90, Globals.EXTEND_POS, 0, false, Globals.boxNeutral , 0, true)); // 9
            targets.add(new RobotState(-3, -2.8 - (2f/3f), 90, Globals.EXTEND_POS, 0, false, Globals.boxDown , 0, true)); // 9
            targets.add(new RobotState(-2.5, -2.8 - (2f/3f), 90, Globals.EXTEND_POS, -1, true, Globals.boxDown, 2100, true)); // 10
    ...
    public void loopOp() {
        ...
        if(paused == 0 && ((target.isRequired() && target.isExact() && (displacement >= 0.25 || angular >= 3 || (robot.ex != null && Math.abs(expos - target.getExtendPos()) >= 300))) || (!target.isRequired() && !target.isExact() && (displacement >= 0.5)) || (target.isRequired() && !target.isExact() && (displacement >= 0.5 || (robot.ex != null && Math.abs(expos - target.getExtendPos()) >= 300))) || (!target.isRequired() && target.isExact() && (displacement >= 0.25 || angular >= 3)))) {
            ...
            else if((index == 13 && skystone != 2) || (index == 14 && skystone == 2)) {
                if(odometry.getY() > 2) {
                    Globals.MAX_SPEED = 0.3;
                }
            }
            ...
            else if((index == 9 || index == 10) && ((skystone == 1 && odometry.getY() < -1.3) || skystone == 0 && odometry.getY() < 0.1)) {
                Globals.MAX_SPEED = 0.3;
            }
