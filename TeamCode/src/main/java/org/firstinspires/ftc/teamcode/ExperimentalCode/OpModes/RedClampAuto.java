...
@Autonomous(name="RED Clamp-Auto", group="Trash")
@Config
//@Disabled
public class RedClampAuto extends MyOpMode {
    ...
    public void startOp() {
        ...
        if(skystone == 0) {
            ...
            targets.add(new ClampedStates(2.4, lowplace + 1, 180, true, StoneClamp.UP, false, 250, false));
            targets.add(new ClampedStates(5.25, lowplace + 1.2, 180, false, StoneClamp.UP, false, 250, false));
        ...
        for(ClampedStates target : targets) {
