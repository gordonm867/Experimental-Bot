...
@Autonomous(name="RED Old Two Stone Autonomous", group="Trash")
@Disabled
public class RedTwoBlk extends MyOpMode {
    ...
    public void startOp() {
        ...
        if(skystone == 0) {
            targets.add(new RobotState(5.25, -3.2, 0, 0, 0, true, Globals.boxNeutral, 0, true));
            targets.add(new RobotState(2.6, -3.7 + (2f/3f), 45, Globals.EXTEND_POS, -1, true, Globals.boxDown, 1000, true));
            targets.add(new RobotState(3.5, -3.5, 40, 0, 0, false, Globals.boxNeutral, 0, true));
            targets.add(new RobotState(3.5, -1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.5, 1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.5, 3.25, 0, 0, 0, false, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.15, 3.25, 0, Globals.EXTEND_POS / 5, 0.5, true, Globals.boxNeutral, 1500, true));
            targets.add(new RobotState(3.5, 1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.5, -1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.5, -1.15, 45, Globals.EXTEND_POS, 0, false, Globals.boxDown , 0, true));
            targets.add(new RobotState(2.6, -1.87 + (2f/3f), 45, Globals.EXTEND_POS, -1, true, Globals.boxDown, 1000, true));
            ...
            targets.add(new RobotState(3.4, 4.5, 0, 0, 0.01, false, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3, 4.5, 0, -1090, 0.5, true, 0.41, 500, false));
            targets.add(new RobotState(5.7, 4.5, 0, -1090, 0.5, true, 0.41, 500, true));
            targets.add(new RobotState(5.7, 4.5, 0, -1090, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(5.7, 4.5, 0, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(5.7, 3, 0, 0, 0, false, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.5, 0.75, 0, 0, 0, true, Globals.boxNeutral, 0, true));
            ...
            targets.add(new RobotState(5.25, -3.2, 0, 0, 0, true, Globals.boxNeutral, 0, true));
            targets.add(new RobotState(2.6, -3.7, 45, Globals.EXTEND_POS, -1, true, Globals.boxDown, 1000, true));
            targets.add(new RobotState(3.5, -3.5, 40, 0, 0, false, Globals.boxNeutral, 0, true));
            targets.add(new RobotState(3.5, -1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.5, 1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.5, 3.25, 0, 0, 0, false, Globals.boxNeutral, 0, false));
            ...
            targets.add(new RobotState(3.5, 1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.5, -1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3, -1.27, 45, Globals.EXTEND_POS, 0, false, Globals.boxDown , 0, true));
            targets.add(new RobotState(2.6, -2, 45, Globals.EXTEND_POS, -1, true, Globals.boxDown, 1000, true));
            targets.add(new RobotState(3.4, -1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.4, 1, 90, 0, 0.01, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.4, 4.5, 0, 0, 0.01, false, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3, 4.5, 0, -1090, 0.5, true, 0.41, 500, false));
            ...
            targets.add(new RobotState(5.25, -3.2, 0, 0, 0, true, Globals.boxNeutral, 0, true));
            targets.add(new RobotState(2.6, -3.7 - (2f/3f), 45, Globals.EXTEND_POS, -1, true, Globals.boxDown, 1000, true));
            targets.add(new RobotState(3.5, -3.5 - (2f/3f), 40, 0, 0, false, Globals.boxNeutral, 0, true));
            targets.add(new RobotState(3.5, -1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.5, 1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.5, 3.25, 0, 0, 0, false, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.15, 3.25, 0, Globals.EXTEND_POS / 5, 0.5, true, Globals.boxNeutral, 1500, true));
            targets.add(new RobotState(3.5, 1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.5, -1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.5, -1.27 - (2f/3f), 45, Globals.EXTEND_POS, 0, false, Globals.boxDown , 0, true));
            targets.add(new RobotState(2.6, -2 - (2f/3f), 45, Globals.EXTEND_POS, -1, true, Globals.boxDown, 1000, true));
            targets.add(new RobotState(3.4, -1, 90, 0, 0, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.4, 1, 90, 0, 0.01, true, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3.4, 4.5, 0, 0, 0.01, false, Globals.boxNeutral, 0, false));
            targets.add(new RobotState(3, 4.5, 0, -1090, 0.5, true, 0.41, 500, false));
    ...
    public void loopOp() {
        ...
        if(paused == 0 && ((target.isRequired() && target.isExact() && (displacement >= 0.15 || angular >= 3 || (robot.ex != null && Math.abs(robot.ex.getCurrentPosition() - target.getExtendPos()) >= 100))) || (!target.isRequired() && !target.isExact() && (displacement >= 0.5)) || (target.isRequired() && !target.isExact() && (displacement >= 0.5 || (robot.ex != null && Math.abs(robot.ex.getCurrentPosition() - target.getExtendPos()) >= 100))) || (!target.isRequired() && target.isExact() && (displacement >= 0.15 || angular >= 3)))) {
            ...
            if((iterations > 50 || Globals.MAX_SPEED == 0.5 && Math.abs(odometry.getX()) > 4.5) && odometry.getY() > 0 && Math.abs((startPoint.distance(lastPoint) * -Globals.DRIVE_FEET_PER_TICK) / ((lasttime - itertime) / 1000.0)) <= 0.015) { // Move on....
                robot.liftbox(target.getBoxPos());
                robot.setInPower(target.getIntakePower());
                if(target.getDelay() != 0) {
                    robot.setDrivePower(0, 0, 0, 0);
