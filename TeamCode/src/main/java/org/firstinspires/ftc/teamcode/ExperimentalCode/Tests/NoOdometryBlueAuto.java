...
@Autonomous(name="LeftPark",group="Scrimmage")
@Disabled
public class NoOdometryBlueAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(skystone == 0) {
            ...
            robot.closeClamp();
            sleep(200);
            robot.lift.setTargetPosition(159);
